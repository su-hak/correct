        ...
        'https://api.openai.com/v1/chat/completions',
        {
          ...
          messages: [
            ...
            },
            {
              ...
              1. 단어의 유효성: 모든 단어가 표준국어대사전에 등재된 단어인가요?
              2. 문법적 정확성: 문법 구조(주어, 목적어, 서술어 등)가 올바른가요?
              3. 의미의 명확성: 문장이 해석에 혼동 없이 명확하게 전달되나요?
              4. 문장의 자연스러움: 어순, 조사 사용, 단어 선택이 자연스러운가요?
              5. 종합 점수: 1부터 10까지 척도로 전체 문장의 자연스러움과 정확성을 평가해 주세요.

              각 질문에 대한 설명은 필요 없습니다.`
            }
          ],
          temperature: 0.3,
          max_tokens: 200,
